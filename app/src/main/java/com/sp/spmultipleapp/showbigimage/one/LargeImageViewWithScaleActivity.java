 ...
 */
public class LargeImageViewWithScaleActivity extends AppCompatActivity
{
    private LargeImageViewWithScaleGestureDetector mLargeImageView;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_large_image_view_with_scale);

        mLargeImageView = (LargeImageViewWithScaleGestureDetector) findViewById(R.id.id_largetImageview);
        try
        {
            InputStream inputStream = getAssets().open("caimogu.jpg");
