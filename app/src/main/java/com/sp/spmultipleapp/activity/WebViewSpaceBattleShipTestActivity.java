...
public class WebViewSpaceBattleShipTestActivity extends AppCompatActivity {
...
//        webView.loadUrl("file:///android_asset/web/pintugame/index.html");//加载asset文件夹下html
        webView.loadUrl("file:///android_asset/web/html5spacebattleship/play.html");//加载asset文件夹下html
    ...
    private WebViewClient webViewClient=new WebViewClient(){
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(WebViewSpaceBattleShipTestActivity.this,"国内不能访问google,拦截该url",Toast.LENGTH_LONG).show();
