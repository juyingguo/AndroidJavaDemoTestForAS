...
public final class CameraManager {
	 ...
	 */
	public void closeDriver(boolean flag/*, IIbotnCameraService ibotnCameraService*/) {
		if (camera != null) {
			camera.release();
			camera = null;
			...
			/*if(flag) {
				if (ibotnCameraService != null)
					try {
						...
						Log.i(TAG, "closeDriver setLevel 0");
					} catch (RemoteException e) {
						e.printStackTrace();
					}
				else {
					Log.i(TAG, "ibotnCameraService == null");
				}
			}*/
		}
	}
	...
	public Rect getFramingRect() {
		if (framingRect == null) {
			...
			if (screenResolution == null) {// 20170825 空指针判断 phc
				return null;
			}
