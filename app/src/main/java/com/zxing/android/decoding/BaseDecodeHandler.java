...
/**
 * 20201230 copy form {@link DecodeHandler},Change the fixed activity(CaptureActivity) to a common base class or interface {@link DecodeInterface}
 */
final class BaseDecodeHandler extends Handler {

	private static final String TAG = BaseDecodeHandler.class.getSimpleName();

	private final DecodeInterface activity;
	private final MultiFormatReader multiFormatReader;

	BaseDecodeHandler(DecodeInterface activity, Hashtable<DecodeHintType, Object> hints) {
