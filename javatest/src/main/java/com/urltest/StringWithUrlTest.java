 ...
 */
public class StringWithUrlTest {
    ...
    public void testReplace() throws UnsupportedEncodingException {
        ...
        boolean containChinese = StringUtils.isContainChinese(oldImgUrl);
        System.out.println("oldImgUrl,containChinese:" + containChinese);

        oldImgUrl = java.net.URLEncoder.encode(oldImgUrl, "UTF-8");
